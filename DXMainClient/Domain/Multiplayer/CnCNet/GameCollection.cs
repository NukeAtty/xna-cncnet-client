...
namespace DTAClient.Domain.Multiplayer.CnCNet
{
    ...
    public class GameCollection
    {
        ...
        public void Initialize()
        {
            ...
            var defaultGames = new CnCNetGame[]
            {
                new CustomCnCNetGame("beicon.png")
                {
                    ChatChannel = "#cncnet-be",
                    ClientExecutableName = "BELauncher.exe",
                    GameBroadcastChannel = "#cncnet-be-games",
                    InternalName = "be",
                    RegistryInstallPath = "HKLM\\Software\\BellumÆternum",
                    UIName = "Bellum Æternum".L10N("Client:ClientCore:BellumAeternum")
                }
            };
